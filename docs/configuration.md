...
For Codex worker launch and relaunch permissions, configured approval review, and home-side supervision limits, see the [Codex launch-permission reference](../.agents/skills/harness-adapters/references/harness/codex.md#launch-permissions).
